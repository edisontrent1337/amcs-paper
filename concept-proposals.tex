...
In order to solve these issues, tab-based layout and navigation is used again. 
Figure \ref{figure:pollviewenhanvement1} shows the first mock-up for the redesign of the \emph{Poll View}.
\paragraph{Iteration 1}
...
In addition to that, the student can use the \emph{Navigation Bar} to freely select a question they wish to answer or review. This eases navigation within a poll, no scrolling is required anymore.
