...
The \emph{Poll View} uses a layout consisting of tabs. Each poll type has a designated tab, esentially reusing the tab component used in the \emph{Main View}.
