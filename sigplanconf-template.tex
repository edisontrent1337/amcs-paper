...
Regarding usability, design and consistency, the challenge lays in these components to provide a unified user interface across all platforms that is intuitive to use but also complies to existing design guidelines of said platforms, e.g. Material Design on Android by Google.
\end{abstract}
