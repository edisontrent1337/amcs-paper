...
\section{Course View}
\todo{Describe the duplicate course view in more detail and cover it in the problems of the application in more detail and also in the list of improvements}
